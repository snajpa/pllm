                  ...
                  when '}'
                    ...
                    if bracket_count == 0 && !current_json.strip.empty?
                      ...
                      if options[:accumulate]
                        accumulated_responses << "PREVIOUS ITERATION START:\n#{current_json}\nPREVIOUS ITERATION END.\n\n"
                      end
                      return
                    end
                  else
...
# --- Prompt Building ---
def build_prompt(mission, scratchpad, terminal_state, accumulated_responses)
...
begin
  ...
  until mission_complete
    ...
    prompt = build_prompt(MISSION, scratchpad, terminal_state, accumulated_responses)
    puts prompt
